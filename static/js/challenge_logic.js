...
// We create the tile layer that will be the background of our map -- Dark Layer
...
// Added layer groups for all earthquakes, tectonic plates, and major earthquakes.
let allEarthquakes = new L.LayerGroup();
let tectonicPlate = new L.LayerGroup();
let majorEarthquake = new L.LayerGroup();


// Added references for all earthquakes, tectonic plates and major earthquakes to the overlays object.
let overlays = {
...
// Retrieved the major earthquake GeoJSON data >4.5 mag for the week.
...
// Creating a GeoJSON layer with the retrieved data that adds a circle to the map sets the style of the circle, and displays the magnitude and location of the earthquake after the marker has been created and styled.
  L.geoJson(data, {
    pointToLayer: function(feature, latlng) {
      console.log(data);
      return L.circleMarker(latlng);
